    ...
    <div class="alert alert-danger">
        <ul>
            ...
            <div class="mb-3">
                ...
                <textarea name="book_description" id="book_description" class="form-control" row='4' required>{{ old('book_description') }}</textarea>
            </div>
    ...
    <script>
        $(document).on('click', '#confirmDeleteCategory', function () {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    alert('Error deleting category. The category still in use.');
                }
            });
        });
    </script>
